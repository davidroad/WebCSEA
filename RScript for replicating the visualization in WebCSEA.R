...
idx <- match(organ_ref$Tissue_cell_type_name ,colnames(heatmap_combine))
heatmap_combine <- heatmap_combine[,idx]
...
##obtain the tissue cell types belong to top 20 tissues.
tissue_idx <- {}
...
##reorder the level of tissue cell types by the order of top 20 tissues.
...
##obtain the tissue cell types belong to top 20 general cell types.
cell_type_idx <- {}
...
##reorder the level of tissue cell types by the order of top 20 general cell types.
